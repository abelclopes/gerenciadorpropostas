...
import { Categoria, CategoriasModel } from '../../logica-api';
...
export class CategoriaService {
    ...
    public novaCategoria(nome: string, descricao: string){
      ...
      return this.httpClient.post<Categoria>(`${API_URL}/api/categorias/`,data,{headers: this.httpHeaders, responseType: 'json'});
    }
    ...
    public updateCategoria(model: Categoria): Observable<PagedListModel> {
