...
namespace API.Model
{
    public class ListaPaginadaModel<T>
    {
        public ListaPaginadaModel(int numeroPagina, int tamanhoPagina)
        {
        ...
        public async Task<ListaPaginadaModel<T>> Carregar(IQueryable<T> source)
        {
        ...
        public ListaPaginadaModel<T> Carregar(List<T> source)
        {
